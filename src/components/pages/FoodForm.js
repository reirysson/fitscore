...
function FoodForm({handleSubmit, alimentoData, acionar}) {
    ...
    return (acionar) ? (
        <div className={styles.popup}>
            ...
            <button type="button" className={styles.close_btn} onClick={() => acionar=(false)}><AiFillCloseCircle /></button>
            <button type="submit" className={styles.save_btn}>Salvar alimento</button>
        </form>
        </div>
    ) : "";
}
